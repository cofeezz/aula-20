...
function setup() {
  // Passo 1: Ajuste a posição de todos os sprites em relação à width (largura) e height(altura)
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    var obstacle = createSprite(width + 50, height - 34, 10, 40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    cloud = createSprite(width + 50, height / 2, 40, 10);
